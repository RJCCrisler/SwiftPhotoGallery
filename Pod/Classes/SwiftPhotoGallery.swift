...
public class SwiftPhotoGallery: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate {
    ...
    override public func viewDidLayoutSubviews() {
        ...
        if pageBeforeRotation > 0 {
            scrollToImage(currentPage, animated: false)
        }
        
        //imageCollectionView.reloadItemsAtIndexPaths([desiredIndexPath])
        
        scrollToImage(startingIndex, animated: false)
    ...
    private func setupPageControl() {
        ...
        let inspiratoBlue: UIColor = UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
    ...
    private func scrollToImage(withIndex:Int, animated:Bool = false) {
        imageCollectionView.scrollToItemAtIndexPath(NSIndexPath(forItem: withIndex, inSection: 0), atScrollPosition: .None, animated: animated)
    }
